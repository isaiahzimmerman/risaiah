var siteList = [
    ...
    {title: 'Civ Arts Study', path: '/civarts/', icon: ['/assets/icons/munson.svg', '/assets/icons/darkmunson.svg'], author: ['isaiah']},
    {title: 'Cube', path: '/cube/', icon: ['/assets/icons/cube.svg', '/assets/icons/darkcube.svg'], author: ['isaiah']},
    {title: 'Sorting Visualizer', path: '/sort/', icon: ['/assets/icons/sorting.svg', '/assets/icons/darksorting.svg'], author: ['isaiah', 'ryan']},
